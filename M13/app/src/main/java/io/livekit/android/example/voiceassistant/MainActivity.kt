                    ...
                    Box(modifier = Modifier.padding(innerPadding)) {
                        ...
                        NavHost(navController, startDestination = ConnectRoute) {
                            ...
                            composable<ConnectRoute> {
                                ConnectScreen { _, _ ->
                                    val url = "wss://m13062005-q3xlwsby.livekit.cloud"
                                    val token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NTU2NjI3MDgsImlkZW50aXR5IjoidGVzdF91c2VyIiwiaXNzIjoiQVBJblZTUnNkSnBmd3dkIiwibmFtZSI6InRlc3RfdXNlciIsIm5iZiI6MTc1NTU3NjMwOCwic3ViIjoidGVzdF91c2VyIiwidmlkZW8iOnsicm9vbSI6InRlc3Rfcm9vbSIsInJvb21Kb2luIjp0cnVlfX0.gSPHctH-XbLs8Dek97sXq5qwIpmXOR6OXQHbWMfbV_g"
                                    runOnUiThread {
